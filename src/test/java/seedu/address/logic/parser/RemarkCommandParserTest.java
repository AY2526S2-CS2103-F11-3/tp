...
public class RemarkCommandParserTest {
    ...
    public void parse_indexSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + " " + PREFIX_REMARK + new Remark(VALID_REMARK);
    ...
    public void parse_missingCompulsoryField_failure() {
        ...
        // no index
        assertParseFailure(parser, RemarkCommand.COMMAND_WORD + " " + VALID_REMARK, expectedMessage);
    }
}
